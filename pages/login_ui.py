...
# Make the page wide
st.set_page_config(layout="wide", page_title="Unnati - Login & Registration")
...
# Check if logged in and redirect to main app
if st.session_state.logged_in:
    # Streamlit will display the main page if this code runs
    import sys
